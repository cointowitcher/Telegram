...
import org.telegramsr1.ui.Cells.WallpaperCell;
...
import org.telegramsr1.ui.Components.WallpaperUpdater;
                    ...
                    fragment.setDelegate((fragment1, dids, message, param) -> {
                        ...
                        if (dids.size() > 1 || dids.get(0) == UserConfig.getInstance(currentAccount).getClientUserId() || message != null) {
                            ...
                            for (int a = 0; a < dids.size(); a++) {
                                long did = dids.get(a);
                                if (message != null) {
                                    SendMessagesHelper.getInstance(currentAccount).sendMessage(message.toString(), did, null, null, null, true, null, null, null, true, 0, null, null);
                                }
                                if (!TextUtils.isEmpty(fmessage)) {
                                    SendMessagesHelper.getInstance(currentAccount).sendMessage(fmessage.toString(), did, null, null, null, true, null, null, null, true, 0, null, null);
                                }
                            }
