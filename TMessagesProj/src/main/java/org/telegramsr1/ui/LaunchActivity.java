...
import org.telegramsr1.PhoneFormat.PhoneFormat;
...
import org.telegramsr1.messenger.ContactsLoadingObserver;
...
import org.telegramsr1.messenger.LocationController;
...
import org.telegramsr1.ui.Cells.LanguageCell;
import org.telegramsr1.ui.Components.AlertsCreator;
import org.telegramsr1.ui.Components.AudioPlayerAlert;
import org.telegramsr1.ui.Components.BlockingUpdateView;
...
import org.telegramsr1.ui.Components.Easings;
import org.telegramsr1.ui.Components.EmbedBottomSheet;
import org.telegramsr1.ui.Components.GroupCallPip;
...
import org.telegramsr1.ui.Components.PasscodeView;
import org.telegramsr1.ui.Components.PhonebookShareAlert;
import org.telegramsr1.ui.Components.PipRoundVideoView;
...
import org.telegramsr1.ui.Components.SharingLocationsAlert;
import org.telegramsr1.ui.Components.SideMenultItemAnimator;
import org.telegramsr1.ui.Components.SizeNotifierFrameLayout;
import org.telegramsr1.ui.Components.StickerSetBulletinLayout;
import org.telegramsr1.ui.Components.StickersAlert;
import org.telegramsr1.ui.Components.TermsOfServiceView;
import org.telegramsr1.ui.Components.ThemeEditorView;
import org.telegramsr1.ui.Components.UndoView;
import org.telegramsr1.ui.Components.UpdateAppAlertDialog;
import org.telegramsr1.ui.Components.voip.VoIPHelper;
        ...
        if (exportingChatUri != null) {
            ...
            if (contactsToSend != null && contactsToSend.size() == 1 && !mainFragmentsStack.isEmpty()) {
                ...
                alert.setDelegate((user, notify, scheduleDate) -> {
                    ...
                    for (int i = 0; i < dids.size(); i++) {
                        SendMessagesHelper.getInstance(account).sendMessage(user, dids.get(i), null, null, null, null, notify, scheduleDate, null);
                    }
                });
                ...
                for (int i = 0; i < dids.size(); i++) {
                    ...
                    if (fragment != null) {
                        ...
                        if (videoPath != null) {
                            ...
                            SendMessagesHelper.prepareSendingDocuments(accountInstance, arrayList, arrayList, null, captionToSend, null, did, null, null, null, null, true, 0, null);
                        }
                    }
                    if (photoPathsArray != null) {
                        ...
                        SendMessagesHelper.prepareSendingMedia(accountInstance, photoPathsArray, did, null, null, null, false, false, null, true, 0, null);
                    }
                    if (documentsPathsArray != null || documentsUrisArray != null) {
                        ...
                        SendMessagesHelper.prepareSendingDocuments(accountInstance, documentsPathsArray, documentsOriginalPathsArray, documentsUrisArray, captionToSend, documentsMimeType, did, null, null, null, null, true, 0, null);
                    }
                    if (sendingText != null) {
                        SendMessagesHelper.prepareSendingText(accountInstance, sendingText, did, true, 0, null);
                    }
                    if (contactsToSend != null && !contactsToSend.isEmpty()) {
                        for (int a = 0; a < contactsToSend.size(); a++) {
                            TLRPC.User user = contactsToSend.get(a);
                            SendMessagesHelper.getInstance(account).sendMessage(user, did, null, null, null, null, true, 0, null);
                        }
                    }
                    if (!TextUtils.isEmpty(message)) {
                        SendMessagesHelper.prepareSendingText(accountInstance, message.toString(), did, true, 0, null);
                    }
                }
            }
