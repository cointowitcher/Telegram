...
import static org.telegramsr1.messenger.MediaDataController.MEDIA_PHOTOVIDEO;
...
import org.telegramsr1.ui.Adapters.SearchAdapterHelper;
import org.telegramsr1.ui.ArticleViewer;
import org.telegramsr1.ui.Cells.ChatActionCell;
import org.telegramsr1.ui.Cells.ContextLinkCell;
...
import org.telegramsr1.ui.Cells.ManageChatUserCell;
import org.telegramsr1.ui.Cells.ProfileSearchCell;
import org.telegramsr1.ui.Cells.SharedAudioCell;
import org.telegramsr1.ui.Cells.SharedDocumentCell;
import org.telegramsr1.ui.Cells.SharedLinkCell;
import org.telegramsr1.ui.Cells.SharedMediaSectionCell;
import org.telegramsr1.ui.Cells.SharedPhotoVideoCell;
import org.telegramsr1.ui.Cells.SharedPhotoVideoCell2;
import org.telegramsr1.ui.Cells.UserCell;
import org.telegramsr1.ui.ChatActivity;
import org.telegramsr1.ui.DialogsActivity;
import org.telegramsr1.ui.MediaCalendarActivity;
import org.telegramsr1.ui.PhotoViewer;
import org.telegramsr1.ui.ProfileActivity;
...
public class SharedMediaLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ActionBarMenuItem getForwardItem() {
        return forwardItem;
    }
            ...
            fragment.setDelegate((fragment1, dids, message, param) -> {
                ...
                if (dids.size() > 1 || dids.get(0) == profileActivity.getUserConfig().getClientUserId() || message != null) {
                    ...
                    for (int a = 0; a < dids.size(); a++) {
                        long did = dids.get(a);
                        if (message != null) {
                            profileActivity.getSendMessagesHelper().sendMessage(message.toString(), did, null, null, null, true, null, null, null, true, 0, null, null);
                        }
                        profileActivity.getSendMessagesHelper().sendMessage(fmessages, did, false, false, true, 0, null);
                    }
